...
<body style="background-image: url('../assets/img/bg.jpg'); background-repeat: no-repeat;
  ...
  <form class="form_container" method="post" action="../host/validate.php">
    <div class="img"><img src="../assets/img/logo1.png" width="150" height="150"/></div>
    <div class="title_container">
      <p class="title">Login to your Account</p>
      <span class="subtitle">Tisha's Book Management Club</span>
    </div>
    <br>
    <div class="input_container">
      ...
      <input placeholder="name@email.com" title="Inpit title" name="email" type="text" class="input_field">
    </div>
    <div class="input_container">
      ...
      <input placeholder="Password" title="Inpit title" name="password" type="password" class="input_field" required>
    </div>
    <button title="Sign In" name="login" type="submit" class="sign-in_btn">
      <span>Sign In</span>
    </button>
